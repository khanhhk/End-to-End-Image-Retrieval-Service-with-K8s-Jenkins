...
search_counter = meter.create_counter(
    name="retriever_search_image_counter",
    description="Number of search_image requests"
)
...
retriever_response_time_summary = Summary(
    "retriever_response_time_summary_seconds",
    "Summary of search_image response time"
)
